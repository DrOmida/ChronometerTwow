		...
		args = {
			...
			commands = {
				...
				args = {
					...
					cmd1 = {type = "text", name = "/chron config - Shows a GUI configuration for Chronometer", order = 10},
					cmd2 = {type = "text", name = "/chron anchor - Shows or hides the anchor to which Chronometer's timer bars are attached", order = 20},
					cmd3 = {type = "text", name = "/chron bar - CandyBar display options", order = 30},
					cmd4 = {type = "text", name = "/chron bar scale - Sets the scale of Chronometer's timer bars", order = 40},
					cmd5 = {type = "text", name = "/chron bar growth - If toggled true, Chronometer's bars appear above the anchor and grow upwards. If toggled false, Chronometer's bars appear below the anchor and grow downwards.", order = 50},
					cmd6 = {type = "text", name = "/chron bar texture - Sets the texture used for the bars", order = 60},
					cmd7 = {type = "text", name = "/chron bar reverse - Toggles reversing the bars (filling up instead of emptying out).", order = 70},
					cmd8 = {type = "text", name = "/chron bar bgalpha - Sets the transparency of the bar background.", order = 80},
					cmd9 = {type = "text", name = "/chron bar bgcolor - Sets the color of the bar background.", order = 90},
					cmd10 = {type = "text", name = "/chron bar color - Sets the default bar color (may be overridden for certain spells).", order = 100},
					cmd11 = {type = "text", name = "/chron bar height - Sets the height of the bars.", order = 110},
					cmd12 = {type = "text", name = "/chron bar text-color - Sets the color of the bar text.", order = 120},
					cmd13 = {type = "text", name = "/chron bar text-size - Sets the size of the bar text.", order = 130},
					cmd14 = {type = "text", name = "/chron bar width - Sets the width of the bars.", order = 140},
					cmd15 = {type = "text", name = "/chron bar text - Sets the text to be displayed on the bar. Use $s for spell name and $t for the target's name.", order = 150},
					cmd16 = {type = "text", name = "/chron test - Runs some test bars so that you can adjust the other options more easily", order = 160},
					cmd17 = {type = "text", name = "/chron kill - If toggled true, Chronometer will stop bars when the NPC or player the spell was cast on dies. When there are multiple NPCs with the same name, this becomes very inaccurate, since it has no way of knowing if the one that died was the same one that you cast the spell on initially. If toggled false, deaths will not stop bars.", order = 170},
					cmd18 = {type = "text", name = "/chron fade - If toggled true, Chronometer will stop bars when the spell fades from the NPC of player it was cast on. As with the kill option, multiple NPCs with the same name will make this option less accurate.", order = 180},
					cmd19 = {type = "text", name = "/chron ghost - Sets the amount of time that ghost bars stay around. This is useful for seeing which spells have recently faded, and allows you to more easily recast the spell using Chronometer's bar-click functions.", order = 190},
					cmd20 = {type = "text", name = "/chron self - Toggles bars for spell durations on the player. Some people didn't want to see these, since they already use another add-on like EBB to give them self-buff/de-buff bars.", order = 200},
				},
			},
			changelog = {
				...
				args = {
					...
					v020a = {type = "text", name = "v0.20 - Adimo", order = 10},
					v020b = {type = "text", name = "Chronometer Adimo Edition rename, website update, and credits updates.", order = 20},
					v020c = {type = "text", name = "Rogue poisons support expanded with timers, charge bars, and weapon poison status.", order = 30},
					v020d = {type = "text", name = "Taste for Blood and Rupture talent scaling updates.", order = 40},
					v020e = {type = "text", name = "SpellCache hearthstone crash fix and duplicate profile menu fix.", order = 50},
					v020f = {type = "text", name = "Direct icon paths and poison bar color/size improvements.", order = 60},
				},
			},
			fubar = { 
