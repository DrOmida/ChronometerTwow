...
function Chronometer:RogueSetup()
    ...
    self:AddTimer(self.EVENT, (BS["Deadly Poison II"] or "Deadly Poison II"), 12, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Deadly Poison III"] or "Deadly Poison III"), 12, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Deadly Poison IV"] or "Deadly Poison IV"), 12, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Deadly Poison V"] or "Deadly Poison V"), 12, 1,0,0, { cr="GREEN", a=1 })
    ...
    self:AddTimer(self.EVENT, (BS["Instant Poison"] or "Instant Poison"), 0, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Instant Poison II"] or "Instant Poison II"), 0, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Instant Poison III"] or "Instant Poison III"), 0, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Instant Poison IV"] or "Instant Poison IV"), 0, 1,0,0, { cr="GREEN", a=1 })
