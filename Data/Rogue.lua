...
function Chronometer:RogueSetup()
    ...
    self:AddTimer(self.EVENT, "Taste for Blood",       14, 0,1,1, { cr="GREEN", a=1, tx="Interface\\Icons\\Ability_Rogue_Rupture" })
    self:AddTimer(self.EVENT, (BS["Corrosive Poison"] or "Corrosive Poison"), 12, 1,0,0, { cr="GREEN", a=1, stacks=1 })
    self:AddTimer(self.EVENT, (BS["Corrosive Poison II"] or "Corrosive Poison II"), 12, 1,0,0, { cr="GREEN", a=1, stacks=1 })
    self:AddTimer(self.EVENT, BS["Deadly Poison"],     12, 1,0,0, { cr="GREEN", a=1, stacks=1 })
    self:AddTimer(self.EVENT, (BS["Deadly Poison II"] or "Deadly Poison II"), 12, 1,0,0, { cr="GREEN", a=1, stacks=1 })
    self:AddTimer(self.EVENT, (BS["Deadly Poison III"] or "Deadly Poison III"), 12, 1,0,0, { cr="GREEN", a=1, stacks=1 })
    self:AddTimer(self.EVENT, (BS["Deadly Poison IV"] or "Deadly Poison IV"), 12, 1,0,0, { cr="GREEN", a=1, stacks=1 })
    self:AddTimer(self.EVENT, (BS["Deadly Poison V"] or "Deadly Poison V"), 12, 1,0,0, { cr="GREEN", a=1, stacks=1 })
    self:AddTimer(self.EVENT, BS["Wound Poison"],      15, 1,0,0, { cr="GREEN", a=1, stacks=1 })
    self:AddTimer(self.EVENT, BS["Mind-numbing Poison"],10,1,0,0,{ cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Mind-numbing Poison II"] or "Mind-numbing Poison II"), 12, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Mind-numbing Poison III"] or "Mind-numbing Poison III"), 14, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, BS["Crippling Poison"],  12, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Crippling Poison II"] or "Crippling Poison II"), 12, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Instant Poison"] or "Instant Poison"), 1800, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Instant Poison II"] or "Instant Poison II"), 1800, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Instant Poison III"] or "Instant Poison III"), 1800, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Instant Poison IV"] or "Instant Poison IV"), 1800, 1,0,0, { cr="GREEN", a=1 })
    self:AddTimer(self.EVENT, (BS["Dissolvent Poison"] or "Dissolvent Poison"), 100, 0,1,1, { cr="GREEN", a=1, tx="Interface\\Icons\\Ability_PoisonSting", chargebar={max=100} })
